...
with col1:
    ...
    opt_detectarom        = st.checkbox("Detect aromaticity",       value=True)
...
tautomer_file = st.file_uploader(
    "SMIRKS tautomers file (optional)",
    type=["txt", "tsv", "smirks"],
...
class_mode = st.radio(
    ...
    options=["active / inactive  (map 1→active, 0→inactive)", "Keep original values"],
    horizontal=True,
)
